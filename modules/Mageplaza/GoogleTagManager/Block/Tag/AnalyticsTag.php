...
class AnalyticsTag extends TagManager implements IdentityInterface
{
    ...
    public function getDimensionsAndMetrics()
    {
        ...
        list($customMap, $values) = $this->getDimensionsMetricsInformation($dimensionsOptions, $customMap, $values);
        list($customMap, $values) = $this->getDimensionsMetricsInformation($metricsOptions, $customMap, $values, false);
