...
class Grid extends \Magento\Reports\Block\Adminhtml\Grid
{
     ...
     * @var array
     */
    protected $_defaultFilters = ['report_from' => '', 'report_to' => '', 'order_status' => '0', 'order_category' => '0', 'report_period' => 'day'];
	...
	public function getCategoryValue()
    {
        ...
        $order_category = $this->getFilter('order_category');
    ...
    public function getAllCategories()
    {
		...
		$orderCategoryArray[] = '';
		$orderCategoryArray[0] = __('Please Select Category');
		...
		if(isset($categories) && count($categories)>0){
			foreach ($categories as $category) {    
				$orderCategoryArray[$category->getId()] = $category->getName();
			}
		}
		
		return $orderCategoryArray;
		
		return ['0' => __('Please Select Category'), '3' => __('Fashion'), '6' => __('Albums'), '36' => __('BT21 Shop'), '59' => __('Electronics')];
		
        /* return $collection->getAllCategories(); */
    }
