 ...
 */
namespace Eextensions\Report\Model\ResourceModel\Report;
...
class Collection extends \Magento\Reports\Model\ResourceModel\Report\Collection
{
    ...
    {
        return ['day' => __('Day 121'), 'month' => __('Month'), 'year' => __('Year')];
    }
    ...
    {
		// $orderStatus = ['denied' => __('1- Processing'), 'complete' => __('Complete'), 'closed' => __('IT WAS RETURNED')];
		...
		// echo "Hello";
		// pr($orderStatusArray);die;
		
		return $orderStatusArray;
		
        return ['denied' => __('1- Processing'), 'complete' => __('Complete'), 'closed' => __('IT WAS RETURNED')];
    }
