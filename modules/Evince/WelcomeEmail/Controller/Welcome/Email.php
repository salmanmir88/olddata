...
namespace Evince\WelcomeEmail\Controller\Welcome;
...
class Email extends \Magento\Framework\App\Action\Action {
    ...
    public function execute() {
        ...
        try {
            ...
            $getMigrateCustomerQuery = " SELECT `email`, `firstname` FROM `customer_entity` WHERE `migrate_customer` = 1 LIMIT 3200,100";
            ...
            foreach ($customers as $customer)
            {
                ...
                $writer = new \Zend\Log\Writer\Stream(BP . '/var/log/welcome47.log');
