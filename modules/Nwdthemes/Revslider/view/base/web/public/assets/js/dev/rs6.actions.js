/********************************************
 * REVOLUTION 6.2.14 EXTENSION - ACTIONS
 * @version: 6.2.14 (20.06.2020)
...
jQuery.extend(true,_R, {
	...
	scrollToId : function(obj) {
		...
		ctop += obj.action==="scrollbelow" ? jQuery(_R[obj.id].slides[0]).height() : 0;

		tpGS.gsap.to(sobj,obj.speed/1000,{_y:(ctop-off), ease:obj.ease,
			onUpdate:function() { _R.document.scrollTop(sobj._y); /* document.documentElement.scrollTop = sobj._y*/},
							            ...
							            success:function(ret, textStatus, XMLHttpRequest) {
							                if(ret.success == true) {
							                	...
							                	setTimeout(function() {
							                		...
							                		_R.document.trigger('RS_OPENMODAL_'+event.modal,event.modalslide);
							                	},49);
							                }
							            },
