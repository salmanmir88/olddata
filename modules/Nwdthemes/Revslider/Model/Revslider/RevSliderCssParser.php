...
class RevSliderCssParser extends RevSliderFunctions {
	...
	public function default_css_classes(){
		...
		return $this->_frameworkHelper->apply_filters('revslider_mod_default_css_handles', $default);
	}
	...
	public function get_captions_sorted(){
		...
		$styles = $wpdb->get_results("SELECT * FROM ".$wpdb->prefix . RevSliderFront::TABLE_CSS . " ORDER BY handle ASC", Query::ARRAY_A);
	...
	public function get_raw_css(){
		...
		$result = $wpdb->get_results("SELECT * FROM ".$wpdb->prefix . RevSliderFront::TABLE_CSS, Query::ARRAY_A);
