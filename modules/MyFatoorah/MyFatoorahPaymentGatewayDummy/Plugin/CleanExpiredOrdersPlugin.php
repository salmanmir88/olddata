...
namespace MyFatoorah\MyFatoorahPaymentGatewayDummy\Plugin;
...
use MyFatoorah\MyFatoorahPaymentGatewayDummy\Controller\Checkout\Success;
    ...
    public function beforeExecute() {
        ...
        foreach ($stores as $storeId => $store) {
            try {
                ...
                $this->mfObj = new PaymentMyfatoorahApiV2D($apiKey, $countryMode, $isTesting, MYFATOORAH_LOG_FILE);
