...
//            $invoiceId = $order->getMyfatoorahInvoiceId();
            if (isset($result1[0]['invoice_id'])) {
                ...
                try {
                    ...
                    $successObj->apiKey = $ScopeConfigInterface->getValue('payment/dummymyfatoorah_gateway/api_key', $scopeStore, $storeId);
                    $isTesting          = $ScopeConfigInterface->getValue('payment/dummymyfatoorah_gateway/is_testing', $scopeStore, $storeId);
