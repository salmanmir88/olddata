...
namespace MyFatoorah\MyFatoorahPaymentGatewayDummy\Helper;
...
class Data extends AbstractHelper {
    ...
    /**
     * @var \MyFatoorah\MyFatoorahPaymentGatewayDummy\Gateway\Config\Config
     */
    ...
    public function getCompleteUrl() {
        return $this->getStoreManager()->getStore()->getBaseUrl() . 'dummymyfatoorah/checkout/success';
    }
    
    public function getProcessUrl() {
        return $this->getStoreManager()->getStore()->getBaseUrl() . 'dummymyfatoorah/checkout/process';
    }
    ...
    public function getCancelledUrl($orderId, $error = null) {
        return $this->getStoreManager()->getStore()->getBaseUrl() . "dummymyfatoorah/checkout/cancel?orderId=$orderId&error=$error";
    }
