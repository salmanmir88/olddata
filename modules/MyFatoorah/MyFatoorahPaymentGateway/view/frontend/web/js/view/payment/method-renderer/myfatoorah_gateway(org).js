                ...
                getGateways: function () {
                    ...
                    var gatewaysArr = _.map(mf_gateways, function (value, key) {
                        ...
                        if (key === 'myfatoorah') {
                            ...
                            if(key === 'uaecc')
                            {
                            var url = '/pub/media/uaecc.png';
                            }else{
                            var url = 'https://portal.myfatoorah.com/imgs/payment-methods/' + key + '.png';
                            }
                        }
                        if(key === 'uaecc'){
                          jQuery('#mf_payment').append('<div class="mf-div"><input type="radio" name="mf_payment" id="myfatoorah_' + key + '" class="radio mf-radio" value="' + key + '"/><label for="myfatoorah_' + key + '"><img src="' + url + '"  class="mf-img credit_'+ key +'" alt="' + value + '"/></label></div>');
                        }else{
