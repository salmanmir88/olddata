...
if (class_exists('\MyFatoorah\Library\PaymentMyfatoorahApiV2')) {
    $mfLibFolder = dirname(\MyFatoorah\Library\PaymentMyfatoorahApiV2::$pmCachedFile);
}
...
\Magento\Framework\Component\ComponentRegistrar::register(
        ...
        'MyFatoorah_MyFatoorahPaymentGateway',
        __DIR__
);
