...
class Data extends AbstractHelper {
    ...
    /**
     * @var \MyFatoorah\EmbedPay\Gateway\Config\Config
     */
    ...
    /**
     * @param \MyFatoorah\EmbedPay\Gateway\Config\Config $gatewayConfig
     ...
     * @param  \Magento\Framework\ObjectManagerInterface $objectManager
     *
     * @return \MyFatoorah\EmbedPay\Helper\Data
     */
    ...
    public function getCompleteUrl() {
        return $this->getStoreManager()->getStore()->getBaseUrl() . 'myfatoorah_embedpay/checkout/success';
    }

    public function getProcessUrl() {
        return $this->getStoreManager()->getStore()->getBaseUrl() . 'myfatoorah_embedpay/checkout/process';
    }
    ...
    public function getCancelledUrl($orderId, $error = null) {
        return $this->getStoreManager()->getStore()->getBaseUrl() . "myfatoorah_embedpay/checkout/cancel?orderId=$orderId&error=$error";
    }
