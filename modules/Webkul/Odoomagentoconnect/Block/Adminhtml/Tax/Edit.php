<?php
namespace Webkul\Odoomagentoconnect\Block\Adminhtml\Tax;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        $this->buttonList->update('save', 'label', __('Save Tax'));
        $this->buttonList->update('delete', 'label', __('Delete Tax'));
