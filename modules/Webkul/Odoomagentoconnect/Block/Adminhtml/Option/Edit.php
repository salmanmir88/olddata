<?php
namespace Webkul\Odoomagentoconnect\Block\Adminhtml\Option;

/**
 * Webkul Odoomagentoconnect Option Edit Block
 *
 * @author    Webkul
 * @api
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        $this->buttonList->update('delete', 'label', __('Delete Option'));
    ...
    public function getHeaderText()
    {
        if ($this->_coreRegistry->registry('permissions_user')->getId()) {
            ...
            return __("Edit Option '%1'", $username);
        } else {
