<?php
/**
 * Webkul Odoomagentoconnect Template MassDelete Controller
 *
 * @category  Webkul
...
/**
 * Webkul Odoomagentoconnect Template MassDelete Controller class
 */
    ...
    public function execute()
    {
        try {
            ...
            if ($collection->getSize() > 0) {
                ...
                $this->messageManager->addSuccess(__('Template deleted succesfully.'));
            }
        } catch (\Exception $e) {
