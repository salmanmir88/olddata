<?php
/**
 * Webkul Odoomagentoconnect Template MassEnable Controller
 *
 * @Template  Webkul
...
/**
 * Webkul Odoomagentoconnect Template MassEnable Controller class
 */
    ...
    public function execute()
    {
        try {
            ...
            if ($collection->getSize() > 0) {
                ...
                $collection->save();
                $this->messageManager->addSuccess(__('Template Need Sync Enabled successfully.'));
            }
        } catch (\Exception $e) {
