<?php
/**
 * Webkul Odoomagentoconnect Product MassDelete Controller
 *
 * @category  Webkul
...
/**
 * Webkul Odoomagentoconnect Product MassDelete Controller class
 */
    ...
    public function execute()
    {
        try {
            ...
            if ($collection->getSize() > 0) {
                ...
                $this->messageManager->addSuccess(__('Product deleted succesfully.'));
            }
        } catch (\Exception $e) {
