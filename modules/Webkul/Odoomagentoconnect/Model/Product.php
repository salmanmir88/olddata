<?php
/**
 * Webkul Odoomagentoconnect Product Model
 *
 * @category  Webkul
...
use Webkul\Odoomagentoconnect\Api\Data\ProductInterface;
use Magento\Framework\DataObject\IdentityInterface;

/**
 * Webkul Odoomagentoconnect Product Model Class
 */
...
*/
     ...
     * CMS page cache tag
     */
    const CACHE_TAG = 'odoomagentoconnect_product';

    /**
     * @var string
     */
    protected $_cacheTag = 'odoomagentoconnect_product';
     ...
     * @var string
     */
    protected $_eventPrefix = 'odoomagentoconnect_product';
    ...
    {
        $this->_init(\Webkul\Odoomagentoconnect\Model\ResourceModel\Product::class);
    }
    /**
