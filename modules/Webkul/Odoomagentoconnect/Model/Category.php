<?php
/**
 * Webkul Odoomagentoconnect Category Model
 *
 * @category  Webkul
...
/**
 * Webkul Odoomagentoconnect Category Model Class
 */
...
*/
     ...
     * CMS page cache tag
     */
    const CACHE_TAG = 'odoomagentoconnect_category';

    /**
     * @var string
     */
    protected $_cacheTag = 'odoomagentoconnect_category';
     ...
     * @var string
     */
    protected $_eventPrefix = 'odoomagentoconnect_category';
    ...
    {
        $this->_init(\Webkul\Odoomagentoconnect\Model\ResourceModel\Category::class);
    }
    /**
