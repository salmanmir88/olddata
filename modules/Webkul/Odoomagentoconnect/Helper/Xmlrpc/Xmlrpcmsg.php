...
use Webkul\Odoomagentoconnect\Helper\Xmlrpc\Xmlrpcresp as xmlrpcresp;

class Xmlrpcmsg extends \Webkul\Odoomagentoconnect\Helper\Xmlrpc
{
    var $payload;
    var $methodname;
    var $params=[];
    ...
    function createPayload($charset_encoding = '')
    {
        ...
        $this->payload.='<methodName>' . $this->xmlrpc_encode_entitites($this->methodname, $GLOBALS['xmlrpc_internalencoding'], $charset_encoding) . "</methodName>\n";
        $this->payload.="<params>\n";
    ...
    function &parseResponse($data = '', $headers_processed = false, $return_type = 'xmlrpcvals')
    {
        ...
        $resp_encoding = $this->guess_encoding(@$GLOBALS['_xh']['headers']['content-type'], $data);
        ...
        if ($return_type == 'phpvals') {
            xml_set_element_handler($parser, [$this,"xmlrpc_se"], [$this,"xmlrpc_ee_fast"]);
        } else {
            xml_set_element_handler($parser, [$this,"xmlrpc_se"], [$this,"xmlrpc_ee"]);
        }

        xml_set_character_data_handler($parser, [$this,"xmlrpc_cd"]);
        xml_set_default_handler($parser, [$this,"xmlrpc_dh"]);
