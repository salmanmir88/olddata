...
class XmlrpcClient extends \Webkul\Odoomagentoconnect\Helper\Xmlrpc
{
    var $path;
    var $server;
    var $port=0;
    ...
    var $accepted_charset_encodings = [];
    ...
    function __construct($path, $server = '', $port = '', $method = '')
    {
        ...
        if (function_exists('gzinflate') || (          function_exists('curl_init') && (($info = curl_version())
