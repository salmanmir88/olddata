...
class Salesorderinvoicepayobserver extends Fetchr_Shipping_Model_Observer implements \Magento\FrameWork\Event\ObserverInterface
{
    ...
    public function execute(\Magento\Framework\Event\Observer $observer) {
        return $this->getCCTrackingNo($observer);
    }
    ...
    public function getCCTrackingNo($observer)
    {
        ...
        if ($autoCCPush == true && $paymentType == 'cd') {
