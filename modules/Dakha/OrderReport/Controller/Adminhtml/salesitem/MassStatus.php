...
class MassStatus extends \Magento\Backend\App\Action
{
    ...
    {
        $itemIds = $this->getRequest()->getParam('salesitem');
        if (!is_array($itemIds) || empty($itemIds)) {
            ...
            try {
                ...
                foreach ($itemIds as $postId) {
                    $post = $this->_objectManager->get('Dakha\OrderReport\Model\Salesitem')->load($postId);
        ...
        return $this->resultRedirectFactory->create()->setPath('orderreport/*/index');
    }
