<?php
/**
 * Copyright © SendMessageAfterPayment All rights reserved.
 * See COPYING.txt for license details.
 */
declare(strict_types=1);

namespace Dakha\SendMessageAfterPayment\Observer\My;

class FatoorahMyFatoorahpaymentgatewaySuccess implements \Magento\Framework\Event\ObserverInterface
{
