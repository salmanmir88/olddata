...
namespace MyFatoorah\ShippingAramex\Model\Carrier;
...
class ShippingAramex extends AbstractCarrier implements CarrierInterface {
     ...
     * @var string
     */
    protected $_code = 'myfatoorah_shippingAramex';
...
//        $this->checkoutSession = $this->objectManager->get('Magento\Checkout\Model\Session');
        ...
        $this->apiKey    = $this->objectManager->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('carriers/myfatoorah_shippingAramex/apiKey');
        $this->isTesting = $this->objectManager->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('carriers/myfatoorah_shippingAramex/isTesting');
        ...
        $writer    = new \Zend\Log\Writer\Stream(BP . '/var/log/myfatoorah_shippingAramex.log');
